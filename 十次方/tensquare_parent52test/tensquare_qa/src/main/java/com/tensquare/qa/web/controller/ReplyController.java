...
public class ReplyController {
	...
	public ResultDTO findAll(){
		return new ResultDTO(true,StatusCode.OK,"查询成功",replyService.findAll());
	}
	...
	public ResultDTO findById(@PathVariable String id){
		return new ResultDTO(true,StatusCode.OK,"查询成功",replyService.findById(id));
	}
    ...
    public ResultDTO findSearch( @RequestBody Map searchMap){
        return new ResultDTO(true,StatusCode.OK,"查询成功",replyService.findSearch(searchMap));
    }
