...
public class ColumnController {
	...
	public ResultDTO findAll(){
		return new ResultDTO(true,StatusCode.OK,"查询成功",columnService.findAll());
	}
	...
	public ResultDTO findById(@PathVariable String id){
		return new ResultDTO(true,StatusCode.OK,"查询成功",columnService.findById(id));
	}
    ...
    public ResultDTO findSearch( @RequestBody Map searchMap){
        return new ResultDTO(true,StatusCode.OK,"查询成功",columnService.findSearch(searchMap));
    }
